...
int main(){
	...
	objReader.readObjFile("testCubeAllSides.obj", vertices, triangles);
	...
	std::vector<Triangle> outputTriangles = createMultipleClusters(vertices, triangles, materials, edges, 30, 45);
